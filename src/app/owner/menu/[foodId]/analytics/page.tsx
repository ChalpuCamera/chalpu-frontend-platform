  ...
  insights: [
    {
      type: "positive",
      title: "고객 만족도 상승 추세",
      description: "최근 3개월간 재주문 의향이 7.8에서 8.5로 꾸준히 상승했습니다",
      impact: "high",
      suggestion: "현재 레시피와 조리법을 유지하되, 품질 관리에 더욱 신경써주세요"
    },
    {
      type: "suggestion",
      title: "간 조절 필요",
      ...
      impact: "medium",
      suggestion: "염도를 5-10% 줄이거나, 별도 간장을 제공하는 방안을 고려해보세요"
    },
    {
      type: "positive",
      title: "재료 품질 호평",
      ...
      <div className="w-full max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">{mockMenuAnalytics.menu.name} 분석</h1>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                    <div>
                      <p className="text-sm font-medium mb-2">재주문 의향 추이</p>
