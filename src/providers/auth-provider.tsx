...
import { validateRoleForPath } from '@/lib/auth';
  ...
  useEffect(() => {
    ...
    const verifyAuth = async () => {
      ...
      if (!isValid) {
        ...
        // If authenticated, validate role for current path
        const isValidRole = validateRoleForPath(pathname, user.role);

        if (!isValidRole) {
          // Redirect to correct role path
